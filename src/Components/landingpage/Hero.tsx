export default function Hero() {
    return (
      <main className="bg-white h-full isolate text-center w-full [scrollbar-width:none]">
        <section className="bg-[linear-gradient(to_right_top,#fd267a,#ff6036)] h-screen w-full">
          <div className="flex flex-col md:flex-row justify-center h-full w-full mx-auto">
            ...
            <div className="flex items-center flex-col justify-center px-4 md:w-1/2">
              <a href="/" className="touch-manipulation text-[#21262e] no-underline">
                <svg aria-hidden="true" viewBox="0 0 519 123" className="D(b) W-[150px] md:W-[200px]">
                  <title>Tinder</title>
                  <g fillRule="evenodd" fill="none">
                    <path fill="var(--color--white, inherit)" d="..."></path>
                    <path fill="var(--color--white, inherit)" d="..."></path>
                  </g>
                </svg>
            ...
            {/* Right Section (Image) */}
            <div className="shrink-0 h-full w-full md:w-1/2">
              <div className="flex flex-col justify-center max-w-[250px] md:max-w-[300px] translate-y-[80px] md:translate-y-[120px] mx-auto">
